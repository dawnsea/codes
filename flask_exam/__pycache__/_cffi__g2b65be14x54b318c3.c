...
int _cffi_f_async_add_fd_read(struct wsgi_request * x0, int x1, int x2)
{
  return async_add_fd_read(x0, x1, x2);
}

int _cffi_f_async_add_fd_write(struct wsgi_request * x0, int x1, int x2)
{
  return async_add_fd_write(x0, x1, x2);
}

void _cffi_f_async_add_timeout(struct wsgi_request * x0, int x1)
{
  async_add_timeout(x0, x1);
}

void _cffi_f_async_schedule_to_req_green(void)
{
  async_schedule_to_req_green();
}

int _cffi_f_close(int x0)
{
  return close(x0);
}

void _cffi_f_free(void * x0)
{
  free(x0);
}

ssize_t _cffi_f_read(int x0, void * x1, size_t x2)
{
  return read(x0, x1, x2);
}

void _cffi_f_set_user_harakiri(int x0)
{
  set_user_harakiri(x0);
}

int _cffi_f_uwsgi_add_file_monitor(uint8_t x0, char * x1)
{
  return uwsgi_add_file_monitor(x0, x1);
}

int _cffi_f_uwsgi_add_timer(uint8_t x0, int x1)
{
  return uwsgi_add_timer(x0, x1);
}

void _cffi_f_uwsgi_alarm_trigger(char * x0, char * x1, size_t x2)
{
  uwsgi_alarm_trigger(x0, x1, x2);
}

char * _cffi_f_uwsgi_binary_path(void)
{
  return uwsgi_binary_path();
}

void _cffi_f_uwsgi_buffer_destroy(struct uwsgi_buffer * x0)
{
  uwsgi_buffer_destroy(x0);
}

struct uwsgi_cache * _cffi_f_uwsgi_cache_by_name(char * x0)
{
  return uwsgi_cache_by_name(x0);
}

char * _cffi_f_uwsgi_cache_item_key(struct uwsgi_cache_item * x0)
{
  return uwsgi_cache_item_key(x0);
}

struct uwsgi_cache_item * _cffi_f_uwsgi_cache_keys(struct uwsgi_cache * x0, uint64_t * x1, struct uwsgi_cache_item * * x2)
{
  return uwsgi_cache_keys(x0, x1, x2);
}

int _cffi_f_uwsgi_cache_magic_clear(char * x0)
{
  return uwsgi_cache_magic_clear(x0);
}

int _cffi_f_uwsgi_cache_magic_del(char * x0, uint16_t x1, char * x2)
{
  return uwsgi_cache_magic_del(x0, x1, x2);
}

int _cffi_f_uwsgi_cache_magic_exists(char * x0, uint16_t x1, char * x2)
{
  return uwsgi_cache_magic_exists(x0, x1, x2);
}

char * _cffi_f_uwsgi_cache_magic_get(char * x0, uint16_t x1, uint64_t * x2, uint64_t * x3, char * x4)
{
  return uwsgi_cache_magic_get(x0, x1, x2, x3, x4);
}

int _cffi_f_uwsgi_cache_magic_set(char * x0, uint16_t x1, char * x2, uint64_t x3, uint64_t x4, uint64_t x5, char * x6)
{
  return uwsgi_cache_magic_set(x0, x1, x2, x3, x4, x5, x6);
}

void _cffi_f_uwsgi_cache_rlock(struct uwsgi_cache * x0)
{
  uwsgi_cache_rlock(x0);
}

void _cffi_f_uwsgi_cache_rwunlock(struct uwsgi_cache * x0)
{
  uwsgi_cache_rwunlock(x0);
}

char * _cffi_f_uwsgi_chunked_read(struct wsgi_request * x0, size_t * x1, int x2, int x3)
{
  return uwsgi_chunked_read(x0, x1, x2, x3);
}

int _cffi_f_uwsgi_connect(char * x0, int x1, int x2)
{
  return uwsgi_connect(x0, x1, x2);
}

void _cffi_f_uwsgi_disconnect(struct wsgi_request * x0)
{
  uwsgi_disconnect(x0);
}

char * _cffi_f_uwsgi_do_rpc(char * x0, char * x1, uint8_t x2, char * * x3, uint16_t * x4, uint64_t * x5)
{
  return uwsgi_do_rpc(x0, x1, x2, x3, x4, x5);
}

char * _cffi_f_uwsgi_get_cflags(void)
{
  return uwsgi_get_cflags();
}

char * _cffi_f_uwsgi_get_dot_h(void)
{
  return uwsgi_get_dot_h();
}

int _cffi_f_uwsgi_is_again(void)
{
  return uwsgi_is_again();
}

void * _cffi_f_uwsgi_malloc(size_t x0)
{
  return uwsgi_malloc(x0);
}

int _cffi_f_uwsgi_metric_dec(char * x0, char * x1, int64_t x2)
{
  return uwsgi_metric_dec(x0, x1, x2);
}

int _cffi_f_uwsgi_metric_div(char * x0, char * x1, int64_t x2)
{
  return uwsgi_metric_div(x0, x1, x2);
}

int64_t _cffi_f_uwsgi_metric_get(char * x0, char * x1)
{
  return uwsgi_metric_get(x0, x1);
}

int _cffi_f_uwsgi_metric_inc(char * x0, char * x1, int64_t x2)
{
  return uwsgi_metric_inc(x0, x1, x2);
}

int _cffi_f_uwsgi_metric_mul(char * x0, char * x1, int64_t x2)
{
  return uwsgi_metric_mul(x0, x1, x2);
}

int _cffi_f_uwsgi_metric_set(char * x0, char * x1, int64_t x2)
{
  return uwsgi_metric_set(x0, x1, x2);
}

int _cffi_f_uwsgi_ready_fd(struct wsgi_request * x0)
{
  return uwsgi_ready_fd(x0);
}

int _cffi_f_uwsgi_register_rpc(char * x0, struct uwsgi_plugin * x1, uint8_t x2, void * x3)
{
  return uwsgi_register_rpc(x0, x1, x2, x3);
}

int _cffi_f_uwsgi_register_signal(uint8_t x0, char * x1, void * x2, uint8_t x3)
{
  return uwsgi_register_signal(x0, x1, x2, x3);
}

char * _cffi_f_uwsgi_request_body_read(struct wsgi_request * x0, ssize_t x1, ssize_t * x2)
{
  return uwsgi_request_body_read(x0, x1, x2);
}

char * _cffi_f_uwsgi_request_body_readline(struct wsgi_request * x0, ssize_t x1, ssize_t * x2)
{
  return uwsgi_request_body_readline(x0, x1, x2);
}

int _cffi_f_uwsgi_response_add_header(struct wsgi_request * x0, char * x1, uint16_t x2, char * x3, uint16_t x4)
{
  return uwsgi_response_add_header(x0, x1, x2, x3, x4);
}

int _cffi_f_uwsgi_response_prepare_headers(struct wsgi_request * x0, char * x1, size_t x2)
{
  return uwsgi_response_prepare_headers(x0, x1, x2);
}

int _cffi_f_uwsgi_response_sendfile_do_can_close(struct wsgi_request * x0, int x1, size_t x2, size_t x3, int x4)
{
  return uwsgi_response_sendfile_do_can_close(x0, x1, x2, x3, x4);
}

int _cffi_f_uwsgi_response_write_body_do(struct wsgi_request * x0, char * x1, size_t x2)
{
  return uwsgi_response_write_body_do(x0, x1, x2);
}

void _cffi_f_uwsgi_set_processname(char * x0)
{
  uwsgi_set_processname(x0);
}

int _cffi_f_uwsgi_signal_add_cron(uint8_t x0, int x1, int x2, int x3, int x4, int x5)
{
  return uwsgi_signal_add_cron(x0, x1, x2, x3, x4, x5);
}

int _cffi_f_uwsgi_signal_add_rb_timer(uint8_t x0, int x1, int x2)
{
  return uwsgi_signal_add_rb_timer(x0, x1, x2);
}

int _cffi_f_uwsgi_signal_registered(uint8_t x0)
{
  return uwsgi_signal_registered(x0);
}

int _cffi_f_uwsgi_signal_send(int x0, uint8_t x1)
{
  return uwsgi_signal_send(x0, x1);
}

int _cffi_f_uwsgi_user_lock(int x0)
{
  return uwsgi_user_lock(x0);
}

int _cffi_f_uwsgi_user_unlock(int x0)
{
  return uwsgi_user_unlock(x0);
}

int _cffi_f_uwsgi_websocket_handshake(struct wsgi_request * x0, char * x1, uint16_t x2, char * x3, uint16_t x4, char * x5, uint16_t x6)
{
  return uwsgi_websocket_handshake(x0, x1, x2, x3, x4, x5, x6);
}

struct uwsgi_buffer * _cffi_f_uwsgi_websocket_recv(struct wsgi_request * x0)
{
  return uwsgi_websocket_recv(x0);
}

struct uwsgi_buffer * _cffi_f_uwsgi_websocket_recv_nb(struct wsgi_request * x0)
{
  return uwsgi_websocket_recv_nb(x0);
}

int _cffi_f_uwsgi_websocket_send(struct wsgi_request * x0, char * x1, size_t x2)
{
  return uwsgi_websocket_send(x0, x1, x2);
}

uint64_t _cffi_f_uwsgi_worker_exceptions(int x0)
{
  return uwsgi_worker_exceptions(x0);
}

int _cffi_f_uwsgi_worker_is_busy(int x0)
{
  return uwsgi_worker_is_busy(x0);
}

ssize_t _cffi_f_write(int x0, void const * x1, size_t x2)
{
  return write(x0, x1, x2);
}

int _cffi_const_UWSGI_DECLARE_EMBEDDED_PLUGINS(long long *out_value)
{
  *out_value = (long long)(UWSGI_DECLARE_EMBEDDED_PLUGINS);
  return (UWSGI_DECLARE_EMBEDDED_PLUGINS) <= 0;
}

int _cffi_const_UWSGI_EVENT_FILEMONITOR_USE_INOTIFY(long long *out_value)
{
  *out_value = (long long)(UWSGI_EVENT_FILEMONITOR_USE_INOTIFY);
  return (UWSGI_EVENT_FILEMONITOR_USE_INOTIFY) <= 0;
}

int _cffi_const_UWSGI_EVENT_TIMER_USE_TIMERFD(long long *out_value)
{
  *out_value = (long long)(UWSGI_EVENT_TIMER_USE_TIMERFD);
  return (UWSGI_EVENT_TIMER_USE_TIMERFD) <= 0;
}

int _cffi_const_UWSGI_EVENT_USE_EPOLL(long long *out_value)
{
  *out_value = (long long)(UWSGI_EVENT_USE_EPOLL);
  return (UWSGI_EVENT_USE_EPOLL) <= 0;
}

int _cffi_const_UWSGI_HAS_IFADDRS(long long *out_value)
{
  *out_value = (long long)(UWSGI_HAS_IFADDRS);
  return (UWSGI_HAS_IFADDRS) <= 0;
}

int _cffi_const_UWSGI_LOAD_EMBEDDED_PLUGINS(long long *out_value)
{
  *out_value = (long long)(UWSGI_LOAD_EMBEDDED_PLUGINS);
  return (UWSGI_LOAD_EMBEDDED_PLUGINS) <= 0;
}

int _cffi_const_UWSGI_LOCK_USE_MUTEX(long long *out_value)
{
  *out_value = (long long)(UWSGI_LOCK_USE_MUTEX);
  return (UWSGI_LOCK_USE_MUTEX) <= 0;
}

int _cffi_const_UWSGI_PCRE(long long *out_value)
{
  *out_value = (long long)(UWSGI_PCRE);
  return (UWSGI_PCRE) <= 0;
}

int _cffi_const_UWSGI_PLUGIN_DIR(long long *out_value)
{
  *out_value = (long long)(UWSGI_PLUGIN_DIR);
  return (UWSGI_PLUGIN_DIR) <= 0;
}

int _cffi_const_UWSGI_ROUTING(long long *out_value)
{
  *out_value = (long long)(UWSGI_ROUTING);
  return (UWSGI_ROUTING) <= 0;
}

int _cffi_const_UWSGI_SSL(long long *out_value)
{
  *out_value = (long long)(UWSGI_SSL);
  return (UWSGI_SSL) <= 0;
}

int _cffi_const_UWSGI_UUID(long long *out_value)
{
  *out_value = (long long)(UWSGI_UUID);
  return (UWSGI_UUID) <= 0;
}

int _cffi_const_UWSGI_VERSION(long long *out_value)
{
  *out_value = (long long)(UWSGI_VERSION);
  return (UWSGI_VERSION) <= 0;
}

int _cffi_const_UWSGI_VERSION_BASE(long long *out_value)
{
  *out_value = (long long)(UWSGI_VERSION_BASE);
  return (UWSGI_VERSION_BASE) <= 0;
}

int _cffi_const_UWSGI_VERSION_CUSTOM(long long *out_value)
{
  *out_value = (long long)(UWSGI_VERSION_CUSTOM);
  return (UWSGI_VERSION_CUSTOM) <= 0;
}

int _cffi_const_UWSGI_VERSION_MAJOR(long long *out_value)
{
  *out_value = (long long)(UWSGI_VERSION_MAJOR);
  return (UWSGI_VERSION_MAJOR) <= 0;
}

int _cffi_const_UWSGI_VERSION_MINOR(long long *out_value)
{
  *out_value = (long long)(UWSGI_VERSION_MINOR);
  return (UWSGI_VERSION_MINOR) <= 0;
}

int _cffi_const_UWSGI_VERSION_REVISION(long long *out_value)
{
  *out_value = (long long)(UWSGI_VERSION_REVISION);
  return (UWSGI_VERSION_REVISION) <= 0;
}

int _cffi_const_UWSGI_XML(long long *out_value)
{
  *out_value = (long long)(UWSGI_XML);
  return (UWSGI_XML) <= 0;
}

int _cffi_const_UWSGI_XML_EXPAT(long long *out_value)
{
  *out_value = (long long)(UWSGI_XML_EXPAT);
  return (UWSGI_XML_EXPAT) <= 0;
}

int _cffi_const_UWSGI_YAML(long long *out_value)
{
  *out_value = (long long)(UWSGI_YAML);
  return (UWSGI_YAML) <= 0;
}

int _cffi_const_UWSGI_ZLIB(long long *out_value)
{
  *out_value = (long long)(UWSGI_ZLIB);
  return (UWSGI_ZLIB) <= 0;
}

int _cffi_const__FILE_OFFSET_BITS(long long *out_value)
{
  *out_value = (long long)(_FILE_OFFSET_BITS);
  return (_FILE_OFFSET_BITS) <= 0;
}

int _cffi_const__LARGEFILE_SOURCE(long long *out_value)
{
  *out_value = (long long)(_LARGEFILE_SOURCE);
  return (_LARGEFILE_SOURCE) <= 0;
}
...
intptr_t _cffi_layout_struct_iovec(intptr_t i)
{
...
static void _cffi_check_struct_uwsgi_buffer(struct uwsgi_buffer *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
...
intptr_t _cffi_layout_struct_uwsgi_buffer(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_buffer y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_buffer),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_buffer, buf),
    sizeof(((struct uwsgi_buffer *)0)->buf),
    offsetof(struct uwsgi_buffer, pos),
    sizeof(((struct uwsgi_buffer *)0)->pos),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_buffer(0);
}

static void _cffi_check_struct_uwsgi_cache(struct uwsgi_cache *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  { struct uwsgi_lock_item * *tmp = &p->lock; (void)tmp; }
}
intptr_t _cffi_layout_struct_uwsgi_cache(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_cache y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_cache),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_cache, lock),
    sizeof(((struct uwsgi_cache *)0)->lock),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_cache(0);
}

static void _cffi_check_struct_uwsgi_cache_item(struct uwsgi_cache_item *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->keysize) << 1);
}
intptr_t _cffi_layout_struct_uwsgi_cache_item(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_cache_item y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_cache_item),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_cache_item, keysize),
    sizeof(((struct uwsgi_cache_item *)0)->keysize),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_cache_item(0);
}

static void _cffi_check_struct_uwsgi_header(struct uwsgi_header *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->modifier1) << 1);
}
intptr_t _cffi_layout_struct_uwsgi_header(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_header y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_header),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_header, modifier1),
    sizeof(((struct uwsgi_header *)0)->modifier1),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_header(0);
}

static void _cffi_check_struct_uwsgi_lock_item(struct uwsgi_lock_item *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
}
intptr_t _cffi_layout_struct_uwsgi_lock_item(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_lock_item y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_lock_item),
    offsetof(struct _cffi_aligncheck, y),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_lock_item(0);
}

static void _cffi_check_struct_uwsgi_opt(struct uwsgi_opt *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
...
intptr_t _cffi_layout_struct_uwsgi_opt(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_opt y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_opt),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_opt, key),
    sizeof(((struct uwsgi_opt *)0)->key),
    offsetof(struct uwsgi_opt, value),
    sizeof(((struct uwsgi_opt *)0)->value),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_opt(0);
}

static void _cffi_check_struct_uwsgi_plugin(struct uwsgi_plugin *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->modifier1) << 1);
...
intptr_t _cffi_layout_struct_uwsgi_plugin(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_plugin y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_plugin),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_plugin, modifier1),
    sizeof(((struct uwsgi_plugin *)0)->modifier1),
    offsetof(struct uwsgi_plugin, suspend),
    sizeof(((struct uwsgi_plugin *)0)->suspend),
    offsetof(struct uwsgi_plugin, resume),
    sizeof(((struct uwsgi_plugin *)0)->resume),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_plugin(0);
}

static void _cffi_check_struct_uwsgi_server(struct uwsgi_server *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  ...
  { struct uwsgi_plugin *(*tmp)[] = &p->p; (void)tmp; }
}
intptr_t _cffi_layout_struct_uwsgi_server(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_server y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_server),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_server, hostname),
    0,  /* char[] */
    offsetof(struct uwsgi_server, mywid),
    sizeof(((struct uwsgi_server *)0)->mywid),
    offsetof(struct uwsgi_server, muleid),
    sizeof(((struct uwsgi_server *)0)->muleid),
    offsetof(struct uwsgi_server, master_process),
    sizeof(((struct uwsgi_server *)0)->master_process),
    offsetof(struct uwsgi_server, exported_opts),
    sizeof(((struct uwsgi_server *)0)->exported_opts),
    offsetof(struct uwsgi_server, exported_opts_cnt),
    sizeof(((struct uwsgi_server *)0)->exported_opts_cnt),
    offsetof(struct uwsgi_server, workers),
    sizeof(((struct uwsgi_server *)0)->workers),
    offsetof(struct uwsgi_server, signal_socket),
    sizeof(((struct uwsgi_server *)0)->signal_socket),
    offsetof(struct uwsgi_server, numproc),
    sizeof(((struct uwsgi_server *)0)->numproc),
    offsetof(struct uwsgi_server, async),
    sizeof(((struct uwsgi_server *)0)->async),
    offsetof(struct uwsgi_server, schedule_to_main),
    sizeof(((struct uwsgi_server *)0)->schedule_to_main),
    offsetof(struct uwsgi_server, schedule_to_req),
    sizeof(((struct uwsgi_server *)0)->schedule_to_req),
    offsetof(struct uwsgi_server, current_wsgi_req),
    sizeof(((struct uwsgi_server *)0)->current_wsgi_req),
    offsetof(struct uwsgi_server, wsgi_req),
    sizeof(((struct uwsgi_server *)0)->wsgi_req),
    offsetof(struct uwsgi_server, p),
    0,  /* struct uwsgi_plugin *[] */
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_server(0);
}

static void _cffi_check_struct_uwsgi_worker(struct uwsgi_worker *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->id) << 1);
  (void)((p->pid) << 1);
  (void)((p->requests) << 1);
  (void)((p->delta_requests) << 1);
  (void)((p->signals) << 1);
  (void)((p->cheaped) << 1);
  (void)((p->suspended) << 1);
  (void)((p->sig) << 1);
  (void)((p->signum) << 1);
  (void)((p->running_time) << 1);
  (void)((p->avg_response_time) << 1);
  (void)((p->tx) << 1);
}
intptr_t _cffi_layout_struct_uwsgi_worker(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct uwsgi_worker y; };
  static intptr_t nums[] = {
    sizeof(struct uwsgi_worker),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct uwsgi_worker, id),
    sizeof(((struct uwsgi_worker *)0)->id),
    offsetof(struct uwsgi_worker, pid),
    sizeof(((struct uwsgi_worker *)0)->pid),
    offsetof(struct uwsgi_worker, requests),
    sizeof(((struct uwsgi_worker *)0)->requests),
    offsetof(struct uwsgi_worker, delta_requests),
    sizeof(((struct uwsgi_worker *)0)->delta_requests),
    offsetof(struct uwsgi_worker, signals),
    sizeof(((struct uwsgi_worker *)0)->signals),
    offsetof(struct uwsgi_worker, cheaped),
    sizeof(((struct uwsgi_worker *)0)->cheaped),
    offsetof(struct uwsgi_worker, suspended),
    sizeof(((struct uwsgi_worker *)0)->suspended),
    offsetof(struct uwsgi_worker, sig),
    sizeof(((struct uwsgi_worker *)0)->sig),
    offsetof(struct uwsgi_worker, signum),
    sizeof(((struct uwsgi_worker *)0)->signum),
    offsetof(struct uwsgi_worker, running_time),
    sizeof(((struct uwsgi_worker *)0)->running_time),
    offsetof(struct uwsgi_worker, avg_response_time),
    sizeof(((struct uwsgi_worker *)0)->avg_response_time),
    offsetof(struct uwsgi_worker, tx),
    sizeof(((struct uwsgi_worker *)0)->tx),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_uwsgi_worker(0);
}

static void _cffi_check_struct_wsgi_request(struct wsgi_request *p)
{
  /* only to generate compile-time warnings or errors */
  (void)p;
  (void)((p->fd) << 1);
  ...
  (void)((p->async_ready_fd) << 1);
  (void)((p->async_last_ready_fd) << 1);
  (void)((p->suspended) << 1);
  { struct uwsgi_header * *tmp = &p->uh; (void)tmp; }
}
intptr_t _cffi_layout_struct_wsgi_request(intptr_t i)
{
  struct _cffi_aligncheck { char x; struct wsgi_request y; };
  static intptr_t nums[] = {
    sizeof(struct wsgi_request),
    offsetof(struct _cffi_aligncheck, y),
    offsetof(struct wsgi_request, fd),
    sizeof(((struct wsgi_request *)0)->fd),
    offsetof(struct wsgi_request, async_id),
    sizeof(((struct wsgi_request *)0)->async_id),
    offsetof(struct wsgi_request, var_cnt),
    sizeof(((struct wsgi_request *)0)->var_cnt),
    offsetof(struct wsgi_request, hvec),
    sizeof(((struct wsgi_request *)0)->hvec),
    offsetof(struct wsgi_request, async_ready_fd),
    sizeof(((struct wsgi_request *)0)->async_ready_fd),
    offsetof(struct wsgi_request, async_last_ready_fd),
    sizeof(((struct wsgi_request *)0)->async_last_ready_fd),
    offsetof(struct wsgi_request, suspended),
    sizeof(((struct wsgi_request *)0)->suspended),
    offsetof(struct wsgi_request, uh),
    sizeof(((struct wsgi_request *)0)->uh),
    -1
  };
  return nums[i];
  /* the next line is not executed, but compiled */
  _cffi_check_struct_wsgi_request(0);
}

struct uwsgi_plugin * _cffi_var_pypy_plugin(void)
{
  return (&pypy_plugin);
}

struct uwsgi_server * _cffi_var_uwsgi(void)
{
  return (&uwsgi);
}

void(* * _cffi_var_uwsgi_pypy_hook_execute_source(void))(char *)
{
  return (&uwsgi_pypy_hook_execute_source);
}

void(* * _cffi_var_uwsgi_pypy_hook_file_loader(void))(char *)
{
  return (&uwsgi_pypy_hook_file_loader);
}

void(* * _cffi_var_uwsgi_pypy_hook_loader(void))(char *)
{
  return (&uwsgi_pypy_hook_loader);
}

void(* * _cffi_var_uwsgi_pypy_hook_paste_loader(void))(char *)
{
  return (&uwsgi_pypy_hook_paste_loader);
}

void(* * _cffi_var_uwsgi_pypy_hook_pythonpath(void))(char *)
{
  return (&uwsgi_pypy_hook_pythonpath);
}

void(* * _cffi_var_uwsgi_pypy_hook_request(void))(struct wsgi_request *)
{
  return (&uwsgi_pypy_hook_request);
}

void(* * _cffi_var_uwsgi_pypy_post_fork_hook(void))(void)
{
  return (&uwsgi_pypy_post_fork_hook);
}

char const * * _cffi_var_uwsgi_pypy_version(void)
{
  return (&uwsgi_pypy_version);
}
